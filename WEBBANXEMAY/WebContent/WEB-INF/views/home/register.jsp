...
.ctn {
	...
	border-radius: 20px;
	background-color: #e9ebee; /* backround trong nhap lieu mau trắng đục */
}
...
.admin {
	width: 50%; /* do rong cua khung nhap lieu register */
	margin: auto;
}
</style>
</head>
<body>
	...
	<div class="container ctn"> <!-- class"container font end cho khung ngoai cua nhap lieu" -->
		<br>
		<h4 style="text-align: center;">Đăng ký tài khoản mới</h4>
		<hr>
		${message}
		<div class="container">
			<div class="admin"> <!-- class="admin" font end cho khung nhap du lieu -->
				<form:form action="home/register.htm" method="post" modelAttribute="user">
						...
						<div class="form-group">
							...
							<form:errors class="errors" path="password"/> <!-- class="errors path="password", path hien thi thong bao loi cua thuoc tinh password -->
						</div>
						<div class="form-group">
							<label class="kc">Xác nhận mật khẩu</label>
							<br>
							<input name="repassword" type="password" class="form-control" maxlength="15"/>
							<p class="errors">${message_pass}</p> <!-- hien thi thong bao loi -->
						</div>
						<div class="form-group">
							<label class="kc">Họ</label>
							<br>
							<form:input path="lastname" type="text" class="form-control" maxlength="50"/> <!-- form:input de nhap lieu -->
