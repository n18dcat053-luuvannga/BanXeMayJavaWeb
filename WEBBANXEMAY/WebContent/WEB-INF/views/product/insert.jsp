...
<body>
	...
	<div class="sidebar">
			...
			<hr>
			<a href="admin/product/index.htm"><i class="fas fa-motorcycle"></i> Quản lý xe</a> <!-- class la nhung bieu tuong -->
	...
	<div class="main">
		<div class="container">
			...
			<hr> <!-- the html dung de chia muc bang duong ke giua cac hàng -->
			${message}
			<form:form action="admin/product/insert.htm" method="post" modelAttribute="product" enctype="multipart/form-data">
				<div class="form-group">
					...
					<form:select class="form-control" style="width: 500px;" path="brand.id" 
							items="${brands}" itemValue="id" itemLabel="name"/> <!-- ModeladdAttribute brands duoc su dung de tao ra cac combobox voi value la thuoc tinh id itemlabel la thuoc tinh name cua moi doi tuong trong list  -->
				</div> <%-- brand.id sẽ chuyển mã của nhãn hàng chọn từ combobox vào Brandid trong bảng Brand. --%>
				<div class="form-group">
					<label class="kc">Mã sản phẩm</label>
					<br>
					<form:input path="id" type="text" class="form-control" style="width: 500px;" autocomplete="off"/>
					<form:errors class="errors" path="id"/> <!-- thong bao loi -->
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<br>
					<form:radiobutton path="type" style="margin-right: 5px" value="Xe tay ga" label="Xe tay ga"/> <!-- su dung ra diobutton thi k can tao list de do du lieu vao listcontrol -->
