		...
		<div class="container">
			...
			<form:form action="admin/product/delete.htm" modelAttribute="product">
				...
				<div class="form-group">
					...
					<br>
					<form:input readonly="true" path="price" type="text" class="form-control" style="width: 500px;"/> <!-- Thuộc tính readonly quy định giá trị trong thẻ input chỉ được dùng để hiển thị (không thể thay đổi): -->
				</div>
				<div class="form-group">
					<label class="kc">Khối lượng</label>
					<br>
					<form:input readonly="true" path="weight" type="text" class="form-control" style="width: 500px;"/> <!-- readonly khoa o nhap k cho thay doi khi xoa -->
				</div>
				<div class="form-group">
