...
<body>
	...
	<div class="main">
		<div class="container">
			...
			<hr>
			${message}
			<form:form action="admin/product/update.htm" method="post" modelAttribute="product" enctype="multipart/form-data"> <!-- Do có chứa file nên form cần có method là post và enctype phải là
multipart/form-data -->
				...
				<div class="form-group">
					...
					<br>
					<input type="file" name="photo"> <!-- type=file la click de nhap hinh  -->
				</div>
