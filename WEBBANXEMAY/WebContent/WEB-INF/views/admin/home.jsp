...
<body>
	...
	<div class="sidebar">
		<div class="admin">
			<i class="fas fa-user-shield"></i> ${sessionScope.admin.getLastname()} ${sessionScope.admin.getFirstname()} <!-- show ten admin -->
		</div>
		<hr>
			<a href="admin/product/index.htm"><i class="fas fa-motorcycle"></i> Quản lý xe</a> <!-- the a de tai link lien ket den admin/...... -->
